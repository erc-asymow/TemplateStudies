...
python run.py --tag=NEWA3ZEROSMEARY3p5 --algo=jac2_systs_vsN --smear

#python run.py --tag=NEWA3ZEROSMEARY3p5 --algo=fit_systs_vsN --post_tag=DEBUG --nevents=100000000
