{
  ...
  leg1->SetNColumns(2);
  leg1->SetHeader("Norm. = 1.0#times10^{8} events, p_{T}/GeV#in[25,60], |#eta|<2.5");

  TString image_name = "deltaM_vs_N_paper2.png";

  vector<TString> files_n;
  vector<TString> files_l;
  files_n.emplace_back("UL_10_4_A0_3_2_A1_2_3_A2_3_2_A3_3_4_A4_3_3_full"); files_l.emplace_back("Cheb");
  //files_n.emplace_back("UL_10_4_A0_2_2_A1_2_3_A2_2_2_A3_3_4_A4_3_3_full"); files_l.emplace_back("A^{(0,2)}_{x}: 3#rightarrow2");
  //files_n.emplace_back("UL_10_4_A0_3_2_A1_3_3_A2_3_2_A3_2_4_A4_3_3_full"); files_l.emplace_back("A^{(3)}_{x}: 3#rightarrow2");
  //files_n.emplace_back("UL_10_4_A0_3_2_A1_3_3_A2_3_2_A3_3_2_A4_3_3_full"); files_l.emplace_back("A^{(3)}_{y}: 4#rightarrow2");
  //files_n.emplace_back("UL_10_4_A0_3_2_A1_3_3_A2_3_2_A3_3_4_A4_1_3_full"); files_l.emplace_back("A^{(4)}_{x}: 3#rightarrow1");
  files_n.emplace_back("UL_3_2_A0_2_2_A1_2_2_A2_2_2_A3_2_2_A4_2_2_corr"); files_l.emplace_back("Corr");
  //files_n.emplace_back("UL_5_2_A0_2_2_A1_2_2_A2_2_2_A3_2_2_A4_2_2_corr"); files_l.emplace_back("UL_{x}: 3#rightarrow5 ");
  //files_n.emplace_back("UL_3_2_A0_2_2_A1_2_2_A2_2_2_A3_1_2_A4_2_2_corr"); files_l.emplace_back("A^{(3)}_{x}: 2#rightarrow1");
  //files_n.emplace_back("UL_3_2_A0_2_2_A1_2_2_A2_2_2_A3_2_2_A4_1_2_corr"); files_l.emplace_back("A^{(3)}_{x}: 2#rightarrow1");
  //files_n.emplace_back("UL_3_2_A0_1_2_A1_1_2_A2_1_2_A3_1_2_A4_1_2_corr"); files_l.emplace_back("A^{(k)}_{x}: 2#rightarrow");
  files_n.emplace_back("UL_8_6_A0_8_6_A1_8_6_A2_8_6_A3_8_6_A4_8_6_grid"); files_l.emplace_back("grid");
