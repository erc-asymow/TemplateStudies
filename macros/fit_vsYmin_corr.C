{
  ...
  //TString image_name = "deltaM_vs_Ymin_paper2_corr_y3p5.eps";
  //TString header     = "L = 1.0#times10^{8} events, p_{T}/GeV#in[p_{T}^{(L)},60], |#eta|<2.5, |y|<3.5";
  float norm_lumi    = (0.100/0.800);
  TString image_name = "deltaM_vs_Ymin_paper2_corr.eps";
  TString header     = "L = 1.0#times10^{8} events, p_{T}/GeV#in[p_{T}^{(L)},60], |#eta|<2.5";
  ...
  mg->GetYaxis()->SetRangeUser(40, 200.);
